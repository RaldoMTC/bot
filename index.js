...
async function zynxzoStart() {
    ...
    if (usePairingCode && !zynxzo.authState.creds.registered) {
        ...
        say("Create By Ranz4You Ganteng", {
            font: 'console',
            align: 'center',
            gradient: [randomcolor, randomcolor]
        });
    ...
    const cFimage = ["https://d.top4top.io/p_3261nct4w1.jpg"]
    ...
    zynxzo.ev.on('connection.update', async (update) => {
        ...
        try {
            ...
            zynxzo.sendMessage('6289601671590@s.whatsapp.net', {
    image: {
        url: `${gambarbanyak}`
        },
    caption: `❗𝐑𝐚𝐧𝐳𝟒𝐲𝐨𝐮 𝕺𝖋𝖋𝖎𝖈𝖎𝖆𝖑 𝗩𝟳.𝟬 𝗦𝘂𝗰𝗰𝗲𝘀 𝗖𝗼𝗻𝗻𝗲𝘁𝗶𝗻𝗴 🌥`
        })
                /*                say("ModsV3\n", {
                                    font: 'block',
                                    align: 'center',
